...
image_set = 'xml_labels'  # 需要转换的文件夹名称（文件夹内放xml标签文件）
imageset2 = 'txt_labels'  # 保存txt的文件夹
# 2.
# 换成你的类别 当前的顺序，就txt 0,1,2,3 四个类别
classes = ['class1', 'class2', 'class3', 'class4', 'class5', 'class6']  # 标注时的标签 注意顺序一定不要错。
 
# 3.
# # 转换文件夹的绝对路径
data_dir = 'D:/Goodluck_babies_VisAlgae23/augmentation'
# 或者 读取当前路径
