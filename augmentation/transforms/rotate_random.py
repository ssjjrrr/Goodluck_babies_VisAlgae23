...
#     images_folder = 'F:\github\Goodluck_babies_VisAlgae23\dataset/train/images'
#     labels_folder = 'F:\github\Goodluck_babies_VisAlgae23\dataset/train/labels'
#     output_images_folder = 'F:/github/Goodluck_babies_VisAlgae23/aug_dataset/rotated/images'
#     output_labels_folder = 'F:/github/Goodluck_babies_VisAlgae23/aug_dataset/rotated/labels'
...
#         # 调用函数进行旋转
#         rot_img, rot_bboxes = rotate_random(img, bboxes)
